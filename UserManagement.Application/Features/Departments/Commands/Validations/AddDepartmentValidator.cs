...
{
    public class AddUserValidator : AbstractValidator<AddDepartmentCommand>
    {
        #region Fields
        ...
        #region Constructors
        public AddUserValidator(IDepartmentService departmentService, IStringLocalizer<SharedResources> localizer)
        {
